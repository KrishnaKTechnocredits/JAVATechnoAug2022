//1. On user define range (parameterized method) print all even numbers Range -> 10 to 15
//2. On user define range print all numbers which is divisible by 5.-> 10 to 30
//3. On user define range print all numbers which is divisible by 5 and divisible by 3. Range -> 5 to 18
//4. On user define range print all numbers which is divisible by 7 or 13. Range -> 5 to 40
//5. Find sum of all the numbers in user define range.Range -> 1 to 5
//6. Find difference between sum of odd numbers and even numbers in a given range Range -> 3 to 9
//7. Print only odd numbers in reverse order. Range -> 10 to 20
