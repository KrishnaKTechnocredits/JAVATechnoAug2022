...
public class ShiftRightZerosInArrays extends ShiftLeftZerosInArrays {
	...
	public static void main(String[] args) {
		...
		System.out.println("Processed array after shifting zeros to RIGHT is: " + Arrays.toString(new ShiftRightZerosInArrays().getProcessedArray(inputArr)));
	}
