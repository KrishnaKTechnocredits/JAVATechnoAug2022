...
package pranjaliV.assignment40;
...
public class CollectionEx40 {
	 ...
	 void printFreqNumArrayList(Integer[] numArray){ //program1
	...
	void printMissingNumArrayList(Integer[] numArray, int start, int end) {//program2
		...
		missingNum.removeAll(input);
		System.out.println(missingNum); // remove all common nums(i.e nums present in input) -- this will give missing num
	}
	...
	public static void main(String[] args) {
		CollectionEx40 ex40 = new CollectionEx40();
	 	...
	 	ex40.printFreqNumArrayList(input1);
	 	System.out.println("");
	 	...
	 	ex40.printMissingNumArrayList(input2,50,60);
	 	System.out.println("");
	 	...
	 	System.out.print("Output : " + ex40.printReverseStringImplace(input3));
	 	System.out.println("");
	 	...
	 	System.out.print("Output : " + ex40.printReverseStringBuilder(input4));
	 	System.out.println("");
