...
public class Assignment_18 {
		...
		public static void main(String[] args) {
			System.out.println(Assignment_18.isDigit("te2cH4no"));
			System.out.println(Assignment_18.rearrangeNewString("t8EcHNo5Cred3iTs"));
			System.out.println(Assignment_18.findFrequencyOfCharacter("TechnoTtcredits", 't'));
		}
	}
