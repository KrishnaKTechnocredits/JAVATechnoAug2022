/*
	 * Program 1 : Write a method to return reverse name input : Maulik output :
	 * kiluaM
	 * 
	 * Program 2 : Write a method to return even position characters from given
	 * String. * input : technocredits output : ehordt
	 * 
	 * Program 3 : Write a method to return even position characters from given
	 * String in reverse. input : technocredits output : tdrohe
	 * 
	 * Program 4 : Write a method to return count of digits in a given string. input
	 * : "Te8chno3cred7it9s" output : 4
	 * 
	 * Program 5 : Write a method to return sum of digits in a given string. input :
	 * "Te8chno3cred7it9s" output : 27 Hint : ch = Character.charAt(index);
	 * Character.isDigit(ch); int num = Character.getNumericValue(ch); '9'
	 */
