...
public class A40_MissingNumbers {
	...
	public static void main(String[] args) {
		...
		int startRange = 50;
		int endRange = 60;
		List<Integer> missingNumList = new A40_MissingNumbers().getMissingNumberList(numArr, startRange, endRange);
		System.out.println(missingNumList);
		
		List<Integer> missingNumList2 = new A40_MissingNumbers().getMissingNumberList2(numArr, startRange, endRange);
