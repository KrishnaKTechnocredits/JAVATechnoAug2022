...
public class Assignment_39 {
	...
	public static void main(String[] args) {
	    ...
	    assignment_39.printDuplicateName(listOfNames);
		System.out.println("");
		...
		System.out.println("Output : " + assignment_39.getUniqueNames(listOfNames2));
		System.out.println("");
		...
		System.out.println("Output : " + assignment_39.getUniqueChars(input3));
		System.out.println("");
		...
		System.out.println("Output : " + assignment_39.removeDuplicateNum(input4));
		System.out.println("");
		...
		System.out.println("Output : " + assignment_39.removeDupNumInsertionOrder(input5));
		System.out.println("");
		...
		System.out.println("Output : " + assignment_39.getDuplicateNumSet(input6));
		System.out.println("");
		...
		System.out.println("Output : " + assignment_39.getDuplicateNumList(input7));
		System.out.println("");
