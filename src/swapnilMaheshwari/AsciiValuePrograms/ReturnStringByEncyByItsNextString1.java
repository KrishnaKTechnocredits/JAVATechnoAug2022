...
public class ReturnStringByEncyByItsNextString1 {

	String getReturnOfString1(String str) {
		String output = "";
	...
	public static void main(String[] args) {
		...
		String strReturn;
		strReturn = new ReturnStringByEncyByItsNextString1().getReturnOfString1(str);
		System.out.println();
