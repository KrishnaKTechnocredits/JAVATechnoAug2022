...
public class ArraysPrograms {
	...
	/*
	 * 2) Write a method to return sum of all non prime numbers which should be
	 * divisible by 5 & 7 from given array. input : {11,35,17,105,44} output : 140
	 * Hint : (35+105 = 28)
	 * 
	 */
	...
	/*
	 * 3) Write a method to return sum of all even numbers in given array. input :
	 * {10,11,15,6} output : 16
	 */
	...
	/*
	 * 4) Write a method to return difference of sum of all even numbers and odd
	 * numbers in given array. input : {10,11,15,6} output : 10 Hint : 16 - 26 = 10
	 */
	...
	/*
	 * 5) Return count of vowels in a given String. input : maulik output : 3
	 * 
	 */
	...
	/*
	 	6) Write a method to count vowels of each name in given array. input :
	  {"Ashish","Aditty","Manjiri","Ankita"} output : Ashish -> 2 Aditty -> 2
	  Manjiri -> 3 Ankita -> 3
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println("Sum of non prime numers which are divisible by 5 and 7 :"
				+ arraysPrograms.getNonPrimeDivisibleBy5and7(input1));
		
		int[] input2 = { 10, 11, 15, 6 };
		System.out.println("Sum of all even number :" + arraysPrograms.getSumOfAllEvenNum(input2));
		System.out.println("Difference of Sum of all even and odd numbers :"
				+ arraysPrograms.getDiffOfSumofAllEvenAndAllOdd(input2));
