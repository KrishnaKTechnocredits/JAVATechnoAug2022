...
public class StringRearrange {
	...
	public static void main(String[] args) {
		...
		char c1 = 't';
		System.out.println(
				"All digit first and then all characters :" + stringRearrange.allDigitAllCharacter("te2cH4no"));
		System.out.println("All upper case letters first then all digits and at the last all small letters :"
				+ stringRearrange.allUpperAllDigitAllLower("t8EcHNo5Cred3iTs"));
		System.out.println("Frequency of character of :" + c1 + " in given string :" + s1 + " are :"
				+ stringRearrange.frequencyOfCharacter(s1, c1));
	}
}
