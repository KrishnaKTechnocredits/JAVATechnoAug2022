...
public class Assignment20 {
	...
	// Method to return sum of all non prime numbers which are also divisible by 5&7
	// from given array
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"Sum of all non prime numbers from given array is -- > \n" + assignment20.getSumOFNonPrimeNumbers(num1));
		...
		int[] num3 = { 10, 11, 15, 6 };
		System.out.println("\nSum of all even numbers from given array is -- >\n" + assignment20.getSumOfEvenNumbers(num3));
		System.out.println("\nDifference of sum of even and odd numbers from given array is -- >\n"
				+ assignment20.getDifferenceOfSumOfEvenOddNumbers(num3));

		String name = "Maulik";
		System.out.println("\nNumber of vowels in given string are -- >\n" + assignment20.getCountOfVowels(name));
		...
		System.out.println("\nName with maximum length from given array is -- >\n" + assignment20.getMaxLengthName(input1));
	}
}