...
public class Assignment35_ExceptionalHandlingExample1 {
...
int getSumOfDigitsInString(String str) {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"The addition of numbers in above string --> " + new Assignment35_ExceptionalHandlingExample1().getSumOfNumbersInString(input));

		System.out.println("\n");

		System.out.println("return sum of all the digits from given String.");
		System.out.println("The input string is --> " + input);
		System.out.println(
				"The addition of digit in above string --> " + new Assignment35_ExceptionalHandlingExample1().getSumOfDigitsInString(input));
	}
}
